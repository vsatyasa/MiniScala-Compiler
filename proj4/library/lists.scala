def listMake1[T](e1: T): List[T] = e1::Nil;
def listMake2[T](e1: T, e2: T): List[T] = e1::listMake1[T](e2);
def listMake3[T](e1: T, e2: T, e3: T): List[T] = e1::listMake2[T](e2, e3);
def listMake4[T](e1: T, e2: T, e3: T, e4: T): List[T] = e1::listMake3[T](e2, e3, e4);
def listMake5[T](e1: T, e2: T, e3: T, e4: T, e5: T): List[T] = e1::listMake4[T](e2, e3, e4, e5);
def listMake6[T](e1: T, e2: T, e3: T, e4: T, e5: T, e6: T): List[T] = e1::listMake5[T](e2, e3, e4, e5, e6);
def listMake7[T](e1: T, e2: T, e3: T, e4: T, e5: T, e6: T, e7: T): List[T] = e1::listMake6[T](e2, e3, e4, e5, e6, e7);
def listMake8[T](e1: T, e2: T, e3: T, e4: T, e5: T, e6: T, e7: T, e8: T): List[T] = e1::listMake7[T](e2, e3, e4, e5, e6, e7, e8);
...
def listPartition[T](p: T => Boolean, l: List[T]): (List[T], List[T]) =
...
def listAppend[T](l1: List[T], l2: List[T]): List[T] =
  if (l1.isEmpty) l2

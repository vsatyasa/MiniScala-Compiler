...
trait PrimitivesOKTests {
 ...
 @Test def testPrimitive23 =
    compileAndInterpret("""
      |val o = 158 / 2;
      |putchar(o);
      |putchar(147976 / 1973 + 3 + 2 - 5);
      |putchar(10)
    """.stripMargin)

  @Test def testPrimitive24 =
    compileAndInterpret("""
      | val o = 2 * 4 * 10 - 1;
      | val k = 5 * 15 + 20 - 15 - 5;
      |putchar(o);
  ...
  @Test def testPrimitive25 =
    compileAndInterpret("""
      | val o = (1 << 7) - 49 + 20 - 15 - 5;
      | val k = 5 * 15;
      |putchar(o);
      |putchar(k);
      |putchar(10)
    ...
    @Test def testPrimitive26 =
    compileAndInterpret("""
      | val o = (128 >> 1)  + 15  + 20 - 3 * 5 - 5;
      | val k = 5 * 15;
      |putchar(o);
      |putchar(k);
      |putchar(10)
  ...
  @Test def testPrimitive27 =
    ...
    @Test def testPrimitive29 =
    compileAndInterpret("""
      | val o = 10 * 10 - 21 + (1 - 1) * 0 ;
      | val k = (2 + 3) * 3 * 5;
      |putchar(o);
      |putchar(k);
      |putchar(10)
